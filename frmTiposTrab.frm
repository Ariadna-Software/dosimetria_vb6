...
Begin VB.Form frmTiposTrab 
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   4200
      TabIndex        =   3
      Tag             =   "Descripcion|T|N|||tipostrab|descripcion|||"
      Text            =   "Dato4"
      Top             =   5520
      Width           =   1600
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   2400
      TabIndex        =   2
      Tag             =   "Código Tipo Trabajo|T|N|||tipostrab|c_tipo_trabajo||S|"
      Text            =   "Dato3"
      Top             =   5520
      Width           =   1600
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   60
      TabIndex        =   0
      Tag             =   "Rama Generica|T|N|||tipostrab|cod_rama_gen||S|"
      Text            =   "Dat"
      Top             =   5520
      Width           =   800
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":041C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":052E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":0640
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":0752
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":0864
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":113E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":1A18
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":22F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":2BCC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":34A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":38F8
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":3A0A
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":3B1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":3C2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposTrab.frx":42A8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTiposTrab.frx":43BA
      Height          =   5025
      Left            =   60
      TabIndex        =   9
      Top             =   480
   ...
   End
End
Attribute VB_Name = "frmTiposTrab"
...
Dim I As Integer
    ...
    CadenaConsulta = "Select tipostrab.cod_rama_gen, ramagene.descripcion, tipostrab.c_tipo_trabajo, "
    CadenaConsulta = CadenaConsulta & " tipostrab.descripcion b from tipostrab, ramagene "
    CadenaConsulta = CadenaConsulta & " where tipostrab.cod_rama_gen = ramagene.cod_rama_gen "
    CargaGrid ("tipostrab.cod_rama_gen = 'xx'")
    'Buscar
...
Dim sql As String
    ...
    '### a mano
    sql = "Seguro que desea eliminar el tipo de trabajo:"
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel, "¡Atención!") = vbYes Then
        'Hay que eliminar
        sql = "Delete from tipostrab where cod_rama_gen='" & adodc1.Recordset!cod_rama_gen
        sql = sql & "' and c_tipo_trabajo='" & adodc1.Recordset!c_tipo_trabajo & "'"
        Conn.Execute sql
        CargaGrid ""
    End If
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar Tipo de Trabajo"
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Case 11
            ...
            Screen.MousePointer = vbHourglass
            FrmListado.Opcion = 17 'Listado de tipos de trabajo
            FrmListado.Show
    Case 12
            Unload Me
    Case Else
...
Private Sub CargaGrid(Optional sql As String)
    ...
    If sql <> "" Then
        ...
        sql = CadenaConsulta
    End If
    sql = sql & " ORDER BY cod_rama_gen, c_tipo_trabajo"
...
If Modo = 1 Then
    'Estamos insertando
     Datos = DevuelveDesdeBD(1, "cod_rama_gen", "tipostrab", "cod_rama_gen|c_tipo_trabajo|", txtAux(0).Text & "|" & txtAux(2).Text & "|", "T|T|", 2)
     If Datos <> "" Then
        MsgBox "Ya existe el tipo de trabajo: " & txtAux(0).Text & "  " & txtAux(2).Text, vbExclamation, "¡Error!"
        b = False
    End If
End If
DatosOk = b
