...
Begin VB.Form frmErroresMigra 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Errores Migración "
   ClientHeight    =   6285
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   10500
   Icon            =   "frmErroresMigra.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6285
   ...
   Begin VB.Frame FrameCancelacion 
      ...
      Begin VB.Image ImgFec 
         ...
         Index           =   0
         Left            =   1860
         Picture         =   "frmErroresMigra.frx":030A
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmErroresMigra.frx":040C
      Height          =   5040
      Left            =   60
      TabIndex        =   7
      Top             =   480
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":0421
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":0533
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":0645
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":0757
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":0869
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":097B
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":1255
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":1B2F
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":2409
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":2CE3
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":35BD
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":3A0F
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":3B21
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":3C33
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":3D45
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmErroresMigra.frx":43BF
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmErroresMigra"
...
Dim I As Integer
    ...
    CadenaConsulta = CadenaConsulta & "from erroresmigra left join dosiscuerpo on erroresmigra.n_registro = dosiscuerpo.n_registro "
    CadenaConsulta = CadenaConsulta & "left join operarios on dosiscuerpo.dni_usuario = operarios.dni "
    CadenaConsulta = CadenaConsulta & "Where erroresmigra.c_tipo = 0 "

'
'    CadenaConsulta = "Select erroresmigra.n_registro, erroresmigra.descripcion, dosiscuerpo.dni_usuario, operarios.apellido_1,"
'    CadenaConsulta = CadenaConsulta & "operarios.apellido_2 , operarios.nombre "
'    CadenaConsulta = CadenaConsulta & "from erroresmigra, dosiscuerpo, operarios "
'    CadenaConsulta = CadenaConsulta & "where erroresmigra.c_tipo = 0 and erroresmigra.n_registro = dosiscuerpo.n_registro and "
'    CadenaConsulta = CadenaConsulta & "dosiscuerpo.dni_usuario = operarios.dni "
...
Dim sql As String
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel, "¡Atención!") = vbYes Then
        ...
        sql = sql & " descripcion = '" & Trim(adodc1.Recordset.Fields(1).Value) & "' and c_tipo = 0"
        Conn.Execute sql
        CargaGrid ""
    End If
...
Private Sub CmdAceptarCancelacion_Click()
    ...
    Else
        MsgBox "Debe introducir los valores de número de registro desde y hasta", vbExclamation, "¡Error!"
...
If modo = 1 Then
    'Estamos insertando
     ...
     If Datos <> "" Then
        MsgBox "Ya existe el numero de registro. Reintroduzca.", vbExclamation, "¡Error!"
        b = False
    End If
End If
DatosOk = b
...
Dim valor As Currency
    ...
    If EsNumerico(txtReg(Index).Text) Then
        ...
        If sql = "" Then
            MsgBox "No existe este número registro. Reintroduzca", vbExclamation, "¡Error!"
            txtReg(Index).Text = ""
            PonerFoco txtReg(Index)
        Else
           If cad1 = "**" Then
                MsgBox "Este número de registro está migrado al CSN. Reintroduzca.", "¡Error!"
                txtReg(Index).Text = ""
                PonerFoco txtReg(Index)
           End If
        End If
