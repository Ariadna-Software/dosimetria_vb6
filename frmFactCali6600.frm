...
Begin VB.Form frmFactCali6600 
   ...
   Caption         =   "Factores de Calibración 6.600"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   5640
   Icon            =   "frmFactCali6600.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   5100
      TabIndex        =   14
      Tag             =   "Tipo|T|N|||factcali6600|tipo||S|"
      Text            =   "Tipo"
      Top             =   5490
      Visible         =   0   'False
      Width           =   390
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   150
      TabIndex        =   0
      Tag             =   "Cristal 1|N|N|0|999.999|factcali6600|cristal_a|||"
      Text            =   "Dato1"
      Top             =   5490
      Width           =   800
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   3435
      TabIndex        =   3
      Tag             =   "Fecha Finalización|F|S|||factcali6600|f_fin|dd/mm/yyyy||"
      Text            =   "Dato4"
      Top             =   5490
      Width           =   1600
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   975
      TabIndex        =   1
      Tag             =   "Cristal 2|N|N|0|999.999|factcali6600|cristal_b|||"
      Text            =   "Dato2"
      Top             =   5490
      Width           =   800
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFactCali6600.frx":030A
      Height          =   4365
      Left            =   135
      TabIndex        =   13
      Top             =   945
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Solapa"
      TabPicture(0)   =   "frmFactCali6600.frx":031F
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "Anillo"
      TabPicture(1)   =   "frmFactCali6600.frx":033B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "Pulsera"
      TabPicture(2)   =   "frmFactCali6600.frx":0357
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":0373
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":0485
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":0597
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":06A9
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":07BB
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":08CD
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":11A7
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":1A81
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":235B
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":2C35
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":350F
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":3961
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":3A73
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":3B85
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":3C97
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCali6600.frx":4311
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmFactCali6600"
...
DataGrid1.Enabled = b And Not b2
  ...
  If SSTab1.Caption <> "Solapa" Then ' xqx
...
Dim I As Integer
    ...
    CargaGrid ("factcali6600.f_inicio = '9999-99-99' and tipo ='" & txtAux(4).Text & "'")
...
Dim sql As String
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel) = vbYes Then
        'Hay que eliminar
        sql = "Delete from factcali6600 where f_inicio='" & Format(adodc1.Recordset!f_inicio, FormatoFecha) & "' and tipo ='" & txtAux(4).Text & "'"
        Conn.Execute sql
        CargaGrid "tipo ='" & txtAux(4).Text & "'"
    End If
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar factor de calibración."
End Sub
    ...
    Select Case Index
      Case 0, 1 ' numericos
            If EsNumerico(txtAux(Index).Text) Then
                ...
                End If
                If SSTab1.Caption <> "Solapa" Then txtAux(1).Text = txtAux(0).Text ' xqx
...
Dim fecaux As Date
  ...
  If CDate(txtAux(2).Text) > fecaux Then
    MsgBox "La fecha final no puede ser menor que la inicial. Reintroduzca.", vbExclamation
    DatosOk = False
    Exit Function
  End If
  ...
  If Not error And Modo = 1 Then
    ...
    sql = "select * from factcali6600 where tipo = '" & txtAux(4).Text & "'"
    ...
    While Not Consulta.EOF And Not error
      ...
      ' ¿Alguna de las fechas se encuentran en un rango de fecha existente?
    ...
    If error Then
      MsgBox "El rango de fechas ya existe o forma parte de uno existente. Reintroduzca.", vbExclamation, "Rango erróneo..."
    End If
