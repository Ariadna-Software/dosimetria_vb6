...
Private Sub cmdReg_Click()
    ...
    If ActiveLock1.RegisteredUser Then
        MsgBox "Se ha registrado con éxito." & vbCrLf & "Deberá reiniciar la aplicación.", vbExclamation, "Registro correcto."
        End
    Else
        MsgBox "Clave de activación incorrecta.", vbExclamation, "¡Error!"
    End If
End Sub
...
Private Sub Form_Load()
    ...
    '    MsgBox "ATENCIÓN: La fecha del sistema ha sido modificada.", vbExclamation
    'End If
End Sub
