...
Begin VB.Form frmFactCali4400 
   ...
   Caption         =   "Factores de Calibración 4.400"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   5850
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   4200
      TabIndex        =   3
      Tag             =   "Fecha Finalización|F|S|||factcali4400|f_fin|dd/mm/yyyy||"
      Text            =   "Dato4"
      Top             =   5520
      Width           =   1600
   End
...
Private Sub CargaGrid(Optional sql As String)
    ...
    I = 3
        DataGrid1.Columns(I).Caption = "F.Finalización"
        DataGrid1.Columns(I).Width = 1500
        TotalAncho = TotalAncho + DataGrid1.Columns(I).Width
        'añadido
...
If Modo = 1 Then
    'Estamos insertando
     ...
     If Datos <> "" Then
        MsgBox "Ya existe el factor de calibración 4400 para esa fecha de inicio. Reintroduzca.", vbExclamation, "¡Error!"
        b = False
    End If
End If
DatosOk = b
