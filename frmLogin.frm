...
' Comentado porque no funciona con las tablas de dosimetría.
...
' Esta función debe de haber quedado de anteriores aplicaciones. El campo codusu no existe en
' la tabla empresadosis de dosimetría. La llamada a la función la he comentado. No me cargo la
' función por si acaso hiciera falta en un futuro usarla (debidamente modificada).
