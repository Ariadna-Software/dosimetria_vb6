...
Begin VB.Form frmLotes 
   ...
   Caption         =   "Factores de Corrección de Lotes Harshaw 6600"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   5640
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   1140
      TabIndex        =   1
      Tag             =   "Cristal 2|N|N|0|999.999|lotes|cristal_b|||"
      Text            =   "Dato2"
      Top             =   5475
      Width           =   800
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   210
      TabIndex        =   0
      Tag             =   "Cristal 1|N|N|0|999.999|lotes|cristal_a|||"
      Text            =   "Dato1"
      Top             =   5520
      Width           =   800
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmLotes.frx":030A
      Height          =   4365
      Left            =   135
      TabIndex        =   12
      Top             =   945
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":031F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":0431
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":0543
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":0655
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":0767
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":0879
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":1153
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":1A2D
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":2307
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":2BE1
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":34BB
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":390D
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":3A1F
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":3B31
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":3C43
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmLotes.frx":42BD
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Solapa"
      TabPicture(0)   =   "frmLotes.frx":43CF
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "Extremidad"
      TabPicture(1)   =   "frmLotes.frx":43EB
...
Dim I As Integer
    ...
    CadenaConsulta = "Select * from lotes where 1=1 "
...
Dim sql As String
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel, "¡Atención!") = vbYes Then
        'Hay que eliminar
        sql = "Delete from lotes where dosimetro_inicial=" & adodc1.Recordset!dosimetro_inicial & " and tipo ='" & txtAux(4).Text & "'"
        Conn.Execute sql
        CargaGrid "tipo ='" & txtAux(4).Text & "'"
    End If
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Case 11
            ...
            Screen.MousePointer = vbHourglass
            FrmListado.Opcion = 29 'Listado factores de lotes
            FrmListado.Show
    Case 12
            Unload Me
    Case Else
...
Dim dosf As Long
  ...
  If Modo = 1 Then
    ...
    sql = "select * from lotes where tipo = '" & txtAux(4).Text & "'"
