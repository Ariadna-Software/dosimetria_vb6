...
Begin VB.Form frmDosisNoHomog 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Dosis No Homogéneas "
   ClientHeight    =   6660
   ClientLeft      =   45
   ClientTop       =   45
   ClientWidth     =   9315
   Icon            =   "frmDosisNoHomog.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   6660
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "N.Registro|N|N|||dosisnohomog|n_registro||S|"
      Text            =   "Text1"
      Top             =   540
      Width           =   1305
   End
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   4
      TabIndex        =   16
      Tag             =   "Migrado|T|S|||dosisnohomog|migrado|||"
      Text            =   "Text1"
      Top             =   5580
      Width           =   495
   End
   Begin VB.Frame Frame4 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   3
         Tag             =   "N.Dosimetro|T|N|||dosisnohomog|n_dosimetro|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   2
         Tag             =   "Codigo Empresa|T|N|||dosisnohomog|n_reg_dosimetro|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   50
      TabIndex        =   15
      Tag             =   "Observaciones|T|S|||dosisnohomog|observaciones|||"
      Text            =   "Text1"
      Top             =   5250
      Width           =   7680
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   5
         TabIndex        =   10
         Tag             =   "Tipo de Medición|T|N|||dosisnohomog|tipo_medicion|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   375
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   8
         Tag             =   "Fecha Migracion|F|N|||dosisnohomog|f_migracion|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   7
         Tag             =   "Fecha Dosis|F|N|||dosisnohomog|f_dosis|dd/mm/yyyy||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1335
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   9
         Tag             =   "Dosis Organo|N|S|0.00|999.99|dosisnohomog|dosis_org|##0.00||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1395
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   50
         Tag             =   "Plantilla/Contrata|T|N|||dosisnohomog|plantilla_contrata|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1245
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   7
         Left            =   180
         MouseIcon       =   "frmDosisNoHomog.frx":0CCA
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":0E1C
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   6
         Left            =   1650
         MouseIcon       =   "frmDosisNoHomog.frx":0EA7
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":0FF9
         ToolTipText     =   "Seleccionar fecha"
         Top             =   210
         Width           =   240
      End
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   8
         Left            =   4710
         MouseIcon       =   "frmDosisNoHomog.frx":1084
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":11D6
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   4
         Tag             =   "Codigo Empresa|T|N|||dosisnohomog|c_empresa|||"
         Text            =   "Text1"
         Top             =   420
         Width           =   1305
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   15
         TabIndex        =   5
         Tag             =   "Codigo Instalación|T|N|||dosisnohomog|c_instalacion|||"
         Text            =   "Text1"
         Top             =   420
         Width           =   1290
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   2
         Left            =   180
         MouseIcon       =   "frmDosisNoHomog.frx":12D8
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":142A
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   4
         Left            =   4530
         MouseIcon       =   "frmDosisNoHomog.frx":152C
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":167E
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   6
         Tag             =   "DNI|T|N|||dosisnohomog|dni_usuario|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   1335
      End
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   5
         Left            =   180
         MouseIcon       =   "frmDosisNoHomog.frx":1780
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":18D2
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   5
         TabIndex        =   12
         Tag             =   "Rama Generica|T|N|||dosisnohomog|rama_generica|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   375
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   5
         TabIndex        =   13
         Tag             =   "Rama Específica|T|N|||dosisnohomog|rama_especifica|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   375
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   14
         Tag             =   "Tipo de Trabajo|T|N|||dosisnohomog|c_tipo_trabajo|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   360
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   1
         Left            =   180
         MouseIcon       =   "frmDosisNoHomog.frx":19D4
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":1B26
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   0
         Left            =   2640
         MouseIcon       =   "frmDosisNoHomog.frx":1C28
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":1D7A
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   3
         Left            =   5580
         MouseIcon       =   "frmDosisNoHomog.frx":1E7C
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisNoHomog.frx":1FCE
   ...
   End
End
Attribute VB_Name = "frmDosisNoHomog"
...
Private Sub BotonEliminar()
    ...
    Cad = "Seguro que desea eliminar la dosis no homogénea:" & Data1.Recordset.Fields(0)
    '**********************************************************
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar Dosis no homogénea"
End Sub
...
Private Sub Text1_LostFocus(Index As Integer)
    ...
    If Index = 8 Or Index = 14 Then
      sql = "select dni_usuario,c_empresa,c_instalacion,c_tipo_trabajo,plantilla_contrata,tipo_medicion from dosimetros "
      sql = sql & "where n_reg_dosimetro = " & Val(Text1(14).Text) & " and n_dosimetro = '"
      sql = sql & Text1(8).Text & "' and tipo_dosimetro = 1"
      ...
      If Not Consulta.EOF Then
        ...
        Text1(11).Text = Consulta!tipo_medicion & ""
...
Dim Titulo As String
        ...
        If Cad <> "" Then
            ...
            frmB.vTitulo = "Dosis no Homogéneas"
            frmB.vSelElem = 0
...
Private Sub PonerCampos()
    ...
    Text2(7).Text = DevuelveDesdeBD(1, "descripcion", "ramagene", "cod_rama_gen|", Trim(Text1(5).Text) & "|", "T|", 1)
    Text2(11).Text = DevuelveDesdeBD(1, "descripcion", "tipmedext", "c_tipo_med|", Trim(Text1(11).Text) & "|", "T|", 1)
...
'        Next I
        ...
        If Datos = "" Then
            If MsgBox("No existe el operario en la empresa introducida. ¿Desea continuar?", vbQuestion + vbYesNo + vbDefaultButton1, "¡Atención!") = vbNo Then
                DatosOk = False
                Exit Function
            End If
        End If
...
If (b = True) And (Modo = 3) Then
     Datos = DevuelveDesdeBD(1, "n_registro", "dosisnohomog", "n_registro|", Text1(7).Text & "|", "N|", 1)
     If Datos <> "" Then
...
Dim sql As String
        ...
        Conn.Execute "Delete  from dosisnohomog " & sql
...
Private Sub CargarDatosDosimetros(nregistro As Long)
    ...
    sql = sql & " where tipo_dosimetro = 1 and n_reg_dosimetro = " & Text1(14).Text & " and n_dosimetro = '" & Text1(8).Text & "'"
...
Private Sub printNou()
    With frmImprimir2
        .cadTabla2 = "dosisnohomog"
        .Informe2 = "DosisNoHomogeneas.rpt"
        If CadB <> "" Then
