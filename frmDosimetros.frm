...
Begin VB.Form frmDosimetros 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Label Label8 
         Caption         =   "Valores C y D sólo válidos en PANASONIC (para resto sin efecto)"
         Height          =   255
         Left            =   1800
         TabIndex        =   63
         Top             =   720
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   15
         TabIndex        =   11
         Tag             =   "Codigo Instalación|T|N|||dosimetros|c_instalacion|||"
         Text            =   "Text1"
         Top             =   600
         Width           =   1305
      End
...
Private Sub cmdAceptar_Click()
    ...
    If Combo4.ListIndex <> -1 Then
      ...
      If Combo4.ListIndex <> 1 Then
        '-- VRS:1.3.5 Si no es Panasonic ponemos los fatores de corrección adicionales
        '   a 1
        Text1(14) = "1"
        Text1(15) = "1"
      End If
...
Dim NumF As String
    ...
    ' ### [DavidV] 10/04/2006: Valores por defecto de los factores de corrección.
    Text1(11).Text = "1"
    Text1(12).Text = "1"
    PonerFoco Combo3
End Sub
...
'    Me.Left = 0
    ...
    ' Protegemos el factor de corrección de los cristales si no es admin.
    ...
    Select Case Index
        Case 0, 2, 4, 7, 8, 9, 13
            ...
            If InStr(1, Text1(Index).Text, "'") > 0 Then
                MsgBox "No puede introducir el carácter ' en ese campo.", vbExclamation, "¡Atención!"
        ...
        Case 11, 12
          ' ### [DavidV] 10/04/2006: Los factores de corrección de cada dosímetro.
...
If CadB = "" Then
    MsgBox vbCrLf & "  Debe introducir alguna condición de búsqueda. " & vbCrLf, vbExclamation, "¡Atención!"
    PonerModo 0
    Exit Sub
End If
...
'        Next I
        ...
        If Text1(6).Text <> "" And Text1(10).Text <> "" Then
            If CDate(Text1(6).Text) > CDate(Text1(10).Text) Then
                MsgBox "La Fecha de Retirada no puede ser inferior a la de Asignación", vbExclamation, "¡Atención!"
                DatosOk = False
                Exit Function
            End If
        End If
        ...
        If Text1(8).Text <> "" And (Combo3.ListIndex <> -1) Then
            If DosimetroEnUso(Text1(8).Text, CLng(Text1(7).Text), Combo3.ListIndex, Text3.Text) Then
                MsgBox "Este dosimetro está asignado. Revise.", vbExclamation, "¡Atención!"
                DatosOk = False
                Exit Function
            End If
        End If
...
If (b = True) And (Modo = 3) Then
    ...
    'la N es pa dir que es numeric
     ...
     If Datos <> "" Then
        MsgBox "Ya existe el número de registro de dosimetro : " & Text1(7).Text, vbExclamation, "¡Atención!"
        DatosOk = False
        IndiceErroneo = 7
        Exit Function
    End If
...
Dim clone_rs As ADODB.Recordset
    ...
    On Error GoTo ESituarData1
        ...
        ' ### [DavidV] 10/04/2006: Pequeña solución improvisada, ya que el Find del recordset
        ' sólo admite una columna como criterio de búsqueda, y aquí necesitamos más para situar
