...
Begin VB.Form frmFondosPana 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Fondos Panasonic"
   ClientHeight    =   6225
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5610
   Icon            =   "frmFondosPana.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   60
      TabIndex        =   0
      Tag             =   "Fondo 2|N|N|0|999.999|fondospana|fondo_2|||"
      Text            =   "Dat"
      Top             =   5520
      Width           =   630
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   765
      TabIndex        =   1
      Tag             =   "Fondo 3|N|N|0|999.999|fondospana|fondo_3|||"
      Text            =   "Dato2"
      Top             =   5520
      Width           =   840
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   1950
      TabIndex        =   2
      Tag             =   "Fecha de Inicio|F|N|||fondospana|f_inicio|dd/mm/yyyy|S|"
      Text            =   "Dato3"
      Top             =   5520
      Width           =   1320
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   3345
      TabIndex        =   3
      Tag             =   "Fecha Finalización|F|S|||fondospana|f_fin|dd/mm/yyyy||"
      Text            =   "Dato4"
      Top             =   5505
      Width           =   1275
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   5085
      TabIndex        =   4
      Tag             =   "Tipo|T|N|||fondospana|tipo||S|"
      Text            =   "Tipo"
      Top             =   5505
      Visible         =   0   'False
      Width           =   390
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":030A
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":041C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":052E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":0640
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":0752
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":0864
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":113E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":1A18
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":22F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":2BCC
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":34A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":38F8
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":3A0A
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":3B1C
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":3C2E
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFondosPana.frx":42A8
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFondosPana.frx":43BA
      Height          =   4365
      Left            =   135
      TabIndex        =   13
      Top             =   930
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Solapa"
      TabPicture(0)   =   "frmFondosPana.frx":43CF
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "Extremidad"
      TabPicture(1)   =   "frmFondosPana.frx":43EB
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
   End
End
Attribute VB_Name = "frmFondosPana"
...
Dim I As Integer
    ...
    CadenaConsulta = "Select * from fondospana where 1=1 "
    CargaGrid ("fondospana.f_inicio = '9999-99-99' and tipo ='" & txtAux(4).Text & "'")
...
Dim sql As String
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel, "¡Atención!") = vbYes Then
        'Hay que eliminar
        sql = "Delete from fondospana where f_inicio='" & Format(adodc1.Recordset!f_inicio, FormatoFecha) & "' and tipo ='" & txtAux(4).Text & "'"
        Conn.Execute sql
        CargaGrid "tipo ='" & txtAux(4).Text & "'"
    End If
...
Dim sql As String
    ...
    Case 10
        ...
        sql = "SELECT f_inicio FROM fondospana WHERE f_fin IS NULL AND tipo = '" & txtAux(4).Text & "'"
        Set Rs = New ADODB.Recordset
        Rs.Open sql, Conn, , , adCmdText
        If Not Rs.EOF Then
          If Format(Rs!f_inicio, "yyyy-MM-dd") = Format(Now, "yyyy-MM-dd") Then
            MsgBox "Ya se han calculado los Fondos hoy. Elimine los datos de hoy si quiere volver a calcularlos.", vbOKOnly + vbExclamation, "¡Error!"
            Exit Sub
          End If
        End If

        frmPanasonic.Show vbModal
        If MsgBox("Desea continuar con el proceso de cálculo", vbQuestion + vbYesNo + vbDefaultButton1, "¡Atención!") = vbYes Then
            'CalculaFondo
            CalculaFondo2 ' VRS:1.3.2
            BotonVerTodos
        End If
    Case 11
        'Imprimimos el listado
        Screen.MousePointer = vbHourglass
        FrmListado.Opcion = 32 'Listado de fondos
        FrmListado.Show
    Case 12
        Unload Me
    Case Else
...
'    DataGrid1.Columns(1).Caption = IIf(cristal1, "Cristal 2", "Cristal 3")
    ' VRS:1.3.3
    DataGrid1.Columns(0).Caption = "D.Superf."
    DataGrid1.Columns(1).Caption = "D.Profun."
...
Dim fecaux As Date
  ...
  If Not error And Modo = 1 Then
    ...
    sql = "select * from fondospana where tipo = '" & txtAux(4).Text & "'"
...
On Error GoTo eCalculaFondo
    ...
    sql = sql & " and tempnc.sistema = 'P' and tempnc.codusu = " & vUsu.codigo
    ...
    sql = sql & "dosimetros.n_dosimetro = tempnc.n_dosimetro and tempnc.sistema = 'P' and tempnc.codusu = " & vUsu.codigo
    ...
    v_med3 = 0
    If v_totfon <> 0 Then
        v_med2 = Round2(v_cris2 / v_totfon, 2)
        v_med3 = Round2(v_cris3 / v_totfon, 2)
    End If
    
    ' actualizamos el ultimo registro
    sql = "update fondospana set f_fin = '" & Format(DateAdd("d", -1, Now), FormatoFecha) & "' "
    sql = sql & "where f_fin is null and tipo = '" & txtAux(4).Text & "'"
    
    Conn.Execute sql
    ' aquii
    ' insertamos el ultimo registro de fondo
    sql = "insert into fondospana (fondo_2, fondo_3, f_inicio, f_fin, tipo) values ("
...
eCalculaFondo:
    If Err.Number <> 0 Then
        ...
        Conn.RollbackTrans
    Else
        MsgBox "Proceso de cálculo realizado correctamente.", , "Cálculo de Fondos."
        Conn.CommitTrans
...
' funcion que calcula el fondo
'-- VRS:1.3.2 (Ahora se utiliza una nueva función de cálculo de fondos)
Private Sub CalculaFondo2()
Dim sql As String
Dim Rs As ADODB.Recordset
...
On Error GoTo eCalculaFondo2
    ...
    Rs.Close
    '-- VRS:1.3.2--------------------
    '   Este es el tramo nuevo donde debemos recalcular correcciones en cada lectura, las guardaremos
    '   en cristal_2 y cristal_3, para que luego la media aritmética funcione bien
    '-- Antes de nada calculamos los fondos para Panasonic
    Dim f1 As String
    Dim f2 As String
    Dim Fondo1 As Single
    Dim Fondo2 As Single
    Dim mSrv1 As Single
    Dim mSrv2 As Single
    Dim PanaObj As CPanasonic
    Dim dato As String
    
    sql = "select * from tempnc, dosimetros where (dosimetros.tipo_dosimetro = 0 or dosimetros.tipo_dosimetro = 2) "
    sql = sql & " and dosimetros.f_retirada is null and dosimetros.n_dosimetro = tempnc.n_dosimetro"
    sql = sql & " and tempnc.sistema = 'P' and tempnc.codusu = " & vUsu.codigo
    Set Rs = New ADODB.Recordset
    ...
    If Not Rs.EOF Then
        Rs.MoveFirst
'        If Not CargarFondos(f1, f2, "S") Then
...
'        Fondo2 = CSng(f2)
        While Not Rs.EOF
            ...
            '-- Buscamos las factores de corrección de los 4 cristales
            sql = "select cristal_a, cristal_b, cristal_c, cristal_d from dosimetros"
            sql = sql & " where n_dosimetro = '" & Rs!n_dosimetro & "'"
            sql = sql & " and (f_retirada is null or f_retirada = '0000-00-00')"
            sql = sql & " and sistema = '" & Rs!Sistema & "'"
            ...
            With PanaObj
              ...
              .E4 = Rs!cristal_4
              If Not rs2.EOF Then
                .corrE1 = rs2!cristal_a
                .corrE2 = rs2!cristal_b
                .corrE3 = rs2!cristal_c
                .corrE4 = rs2!cristal_d
              Else
                .corrE1 = 1
                .corrE2 = 1
                .corrE3 = 1
                .corrE4 = 1
              End If
                dato = DevuelveDesdeBD(1, "cristal_a", "lotespana", "dosimetro_inicial|dosimetro_final|tipo|", "<=" & Rs!n_dosimetro & "|>=" & Rs!n_dosimetro & "|" & "S" & "|", "N|N|T|", 3)
                If dato <> "" Then
                  .corrLote = CSng(dato)
                Else
                  .corrLote = 1
            ...
            End With
            Set PanaObj = Nothing
'            mSrv1 = Round2((mSrv1 - CSng(Fondo1)), 3)
'            mSrv2 = Round2((mSrv2 - CSng(Fondo2)), 3)
            mSrv1 = Round2(mSrv1, 3)
            mSrv2 = Round2(mSrv2, 3)
            sql = "update tempnc set cristal_2 = " & TransformaComasPuntos(Format(mSrv1, "0.000"))
            sql = sql & ", cristal_3 = " & TransformaComasPuntos(Format(mSrv2, "0.000"))
            sql = sql & " where codusu = " & CStr(Rs!Codusu)
            sql = sql & " and fecha_lectura = '" & Format(Rs!fecha_lectura, "yyyy-mm-dd") & "'"
            'sql = sql & " and hora_lectura = '" & Format(rs!hora_lectura, "hh:mm:ss") & "'"
            sql = sql & " and n_dosimetro = '" & Rs!n_dosimetro & "'"
            sql = sql & " and sistema = '" & Rs!Sistema & "'"
            Conn.Execute sql
            Rs.MoveNext
        Wend
    Else
        MsgBox "No se han encontrado dosímetros coincidentes, no hay aplicación de correciones", vbInformation
    End If
    Rs.Close
    '----------------------------------
