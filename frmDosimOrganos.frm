...
Begin VB.Form frmDosimOrganos 
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   15
         TabIndex        =   4
         Tag             =   "Codigo Instalación|T|N|||dosimorganos|c_instalacion|||"
         Text            =   "Text1"
         Top             =   600
         Width           =   1305
      End
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar Dosímetro a órganos"
End Sub
...
Dim Cad As String
    ...
    If (b = True) And ((Modo = 3) Or (Modo = 4)) Then
        ...
        If Datos = "" Then
            If MsgBox("No existe la Instalación para la Empresa. Desea continuar.", vbQuestion + vbYesNo + vbDefaultButton2) = False Then
                DatosOk = False
                Exit Function
            End If
        End If
