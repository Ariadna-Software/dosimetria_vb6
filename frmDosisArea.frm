...
Begin VB.Form frmDosisArea 
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "N.Registro|N|N|||dosisarea|n_registro||S|"
      Text            =   "Text1"
      Top             =   540
      Width           =   1305
   End
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   4
      TabIndex        =   16
      Tag             =   "Migrado|T|S|||dosisarea|migrado|||"
      Text            =   "Text1"
      Top             =   5580
      Width           =   495
   End
   Begin VB.Frame Frame4 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   3
         Tag             =   "N.Dosimetro|T|N|||dosisarea|n_dosimetro|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   2
         Tag             =   "Registro Dosímetro|T|N|||dosisarea|n_reg_dosimetro|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   120
      TabIndex        =   15
      Tag             =   "Observaciones|T|S|||dosisarea|observaciones|||"
      Text            =   "Text1"
      Top             =   5250
      Width           =   7680
   End
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   8
         Tag             =   "Fecha Migracion|F|N|||dosisarea|f_migracion|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1305
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   7
         Tag             =   "Fecha Dosis|F|N|||dosisarea|f_dosis|dd/mm/yyyy||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1335
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   9
         Tag             =   "Dosis Superficial|N|S|0.00|999.99|dosisarea|dosis_superf|##0.00||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1395
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   10
         Tag             =   "Dosis Profunda|N|N|0,00|999,99|dosisarea|dosis_profunda|##0.00||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1425
      End
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmDosisArea.frx":0CCA
         Left            =   7410
         List            =   "frmDosisArea.frx":0CCC
         TabIndex        =   11
         Text            =   "Combo1"
         Top             =   480
         Width           =   1335
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   51
         Tag             =   "Plantilla/Contrata|T|N|||dosisarea|plantilla_contrata|||"
         Text            =   "Text1"
         Top             =   480
         Width           =   1245
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   7
         Left            =   180
         MouseIcon       =   "frmDosisArea.frx":0CCE
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":0E20
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   6
         Left            =   1935
         MouseIcon       =   "frmDosisArea.frx":0EAB
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":0FFD
         ToolTipText     =   "Seleccionar fecha"
         Top             =   210
         Width           =   240
      End
   ...
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   4
         Tag             =   "Codigo Empresa|T|N|||dosisarea|c_empresa|||"
         Text            =   "Text1"
         Top             =   420
         Width           =   1305
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   15
         TabIndex        =   5
         Tag             =   "Codigo Instalación|T|N|||dosisarea|c_instalacion|||"
         Text            =   "Text1"
         Top             =   420
         Width           =   1290
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   2
         Left            =   180
         MouseIcon       =   "frmDosisArea.frx":1088
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":11DA
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   4
         Left            =   4530
         MouseIcon       =   "frmDosisArea.frx":12DC
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":142E
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   6
         Tag             =   "DNI|T|N|||dosisarea|dni_usuario|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   1335
      End
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   5
         Left            =   180
         MouseIcon       =   "frmDosisArea.frx":1530
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":1682
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   5
         TabIndex        =   12
         Tag             =   "Rama Generica|T|N|||dosisarea|rama_generica|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   375
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   5
         TabIndex        =   13
         Tag             =   "Rama Específica|T|N|||dosisarea|rama_especifica|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   375
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   14
         Tag             =   "Tipo de Trabajo|T|N|||dosisarea|c_tipo_trabajo|||"
         Text            =   "Text1"
         Top             =   450
         Width           =   360
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   1
         Left            =   180
         MouseIcon       =   "frmDosisArea.frx":1784
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":18D6
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   0
         Left            =   2640
         MouseIcon       =   "frmDosisArea.frx":19D8
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":1B2A
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   3
         Left            =   5580
         MouseIcon       =   "frmDosisArea.frx":1C2C
         MousePointer    =   99  'Custom
         Picture         =   "frmDosisArea.frx":1D7E
   ...
   End
End
Attribute VB_Name = "frmDosisArea"
...
Private Sub BotonEliminar()
    ...
    Cad = "Seguro que desea eliminar la dosis de área:" & Data1.Recordset.Fields(0)
    '**********************************************************
...
Private Sub Text1_LostFocus(Index As Integer)
    ...
    If Index = 8 Or Index = 14 Then
      ...
      sql = sql & Text1(8).Text & "' and tipo_dosimetro = 2"
...
'        Next I
        ...
        'DAVIDG###
        Datos = DevuelveDesdeBD(1, "dni", "operainstala", "c_empresa|dni|", Text1(0).Text & "|" & Text1(9).Text & "|", "T|T|", 2)
...
If (b = True) And (Modo = 3) Then
     Datos = DevuelveDesdeBD(1, "n_registro", "dosisarea", "n_registro|", Text1(7).Text & "|", "N|", 1)
     If Datos <> "" Then
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 11
            FrmListado.OptIns(2).Value = False
            FrmListado.OptIns(3).Value = False
            FrmListado.OptIns(4).Value = True
            FrmListado.Opcion = 9
            FrmListado.Show
        Case Else
...
Dim sql As String
        ...
        Conn.Execute "Delete  from dosisarea " & sql
...
Private Sub CargarDatosDosimetros(nregistro As Long)
    ...
    sql = sql & " where tipo_dosimetro = 2 and n_reg_dosimetro = " & Text1(14).Text & " and n_dosimetro = '" & Text1(8).Text & "'"
