...
Begin VB.Form frmBuscaGrid 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmBuscaGrid.frx":030A
      Height          =   3075
      Left            =   120
      TabIndex        =   1
      Top             =   1920
...
'Si viene de una busqueda previa
'Public vBuscaPrevia As Boolean
...
Private Sub Adodc1_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    If adodc1.Recordset.RecordCount > 0 Then
        Text1.Text = adodc1.Recordset.Fields(CabTablas(vSelElem))
    End If
End Sub
...
If MsgBox(Cad, vbQuestion + vbYesNoCancel + vbDefaultButton2, "¡Atención!") <> vbYes Then Exit Sub   'VRS:1.0.1(11)
If ColIndex <= TotalArray Then
    ...
    Screen.MousePointer = vbDefault
    Else
    MsgBox "Error cargando tabla. Imposible ordenacion", vbCritical, "¡Error!"
End If
End Sub
...
If PrimeraVez Then
    ...
    If Not OK Then
        ...
        Exit Sub
    End If
    If vCargaFrame = False Then 'vBuscaPrevia And
        CargaGrid
    Else
        CargaFrame
    End If
...
'    txtbusqueda.SetFocus
    If vCargaFrame Then
        ...
        ConfiguraForm (1)
    Else
'        Unload Me           lo acabo de añadir
        frameBusqueda.Visible = True ' lo acabo de añadir
        ConfiguraForm (0)            ' lo acabo de añadir
...
Case 1 'Tamaño pequeño sin Grid
