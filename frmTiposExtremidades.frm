...
Begin VB.Form frmTiposExtremidades 
   ...
   ClientTop       =   45
   ClientWidth     =   5700
   Icon            =   "frmTiposExtremidades.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   6210
   ...
   Begin VB.TextBox Txtaux 
      ...
      MaxLength       =   30
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||tipmedext|descripcion|||"
      Text            =   "Dato2"
      Top             =   4320
      Width           =   3765
   End
   Begin VB.TextBox Txtaux 
      ...
      Left            =   180
      TabIndex        =   0
      Tag             =   "Código|T|N|||tipmedext|c_tipo_med||S|"
      Text            =   "Dat"
      Top             =   4320
      Width           =   800
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":0CCA
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":0DDC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":0EEE
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":1000
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":1112
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":1224
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":1AFE
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":23D8
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":2CB2
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":358C
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":3E66
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":42B8
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":43CA
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":44DC
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":45EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmTiposExtremidades.frx":4C68
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmTiposExtremidades.frx":4D7A
      Height          =   4995
      Left            =   60
      TabIndex        =   7
      Top             =   450
   ...
   End
End
Attribute VB_Name = "frmTiposExtremidades"
...
Private Sub BotonBuscar()
    ...
    CadenaConsulta = "Select c_tipo_med, descripcion "
    CadenaConsulta = CadenaConsulta & " from tipmedext where 1 = 1 "
    CargaGrid ("c_tipo_med = 'xx'")
...
Dim sql As String
    ...
    '### a mano
    sql = "Seguro que desea eliminar el tipo de Medición de Extremidad:"
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel + vbDefaultButton2, "¡Atención!") = vbYes Then  'VRS:1.0.1(11)
        'Hay que eliminar
        sql = "Delete from tipmedext where c_tipo_med = '" & adodc1.Recordset!c_tipo_med & "'"
        Conn.Execute sql
        CargaGrid ""
    End If
Error2:
        Screen.MousePointer = vbDefault
        If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar Tipo de Extremidad de Medición"
End Sub
...
'    PonerOpcionesMenu
    ...
    CadenaConsulta = "Select c_tipo_med, descripcion "
    CadenaConsulta = CadenaConsulta & " from tipmedext "
...
Private Function SugerirCodigoSiguiente() As String
    ...
    sql = "Select Max(c_tipo_med) from tipmedext"
...
If Modo = 1 Then
    'Estamos insertando
     Datos = DevuelveDesdeBD(1, "c_tipo_med", "tipmedext", "c_tipo_med|", txtAux(0).Text & "|", "T|", 1)
     If Datos <> "" Then
        MsgBox "Ya existe el tipo de medición sobre extremidad : " & txtAux(0).Text, vbExclamation, "¡Error!"
        b = False
    End If
End If
DatosOk = b
