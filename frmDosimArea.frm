...
Begin VB.Form frmDosimArea 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Dosímetros Area"
   ClientHeight    =   6120
   ClientLeft      =   45
   ClientTop       =   45
   ClientWidth     =   7980
   Icon            =   "frmDosimArea.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   6120
   ...
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   40
      TabIndex        =   2
      Tag             =   "N.Dosimetro|T|N|||dosimarea|n_dosimetro||N|"
      Text            =   "Text1"
      Top             =   480
      Width           =   1305
   End
   Begin VB.TextBox Text1 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "N.Registro|N|N|||dosimarea|n_reg_dosimetro||S|"
      Text            =   "Text1"
      Top             =   480
      Width           =   1305
   End
   Begin VB.Frame Frame7 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   3
         Tag             =   "Codigo Empresa|T|N|||dosimarea|c_empresa|||"
         Text            =   "Text1"
         Top             =   240
         Width           =   1305
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   15
         TabIndex        =   4
         Tag             =   "Codigo Instalación|T|N|||dosimarea|c_instalacion|||"
         Text            =   "Text1"
         Top             =   600
         Width           =   1305
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   2
         Left            =   1470
         MouseIcon       =   "frmDosimArea.frx":0CCA
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":0E1C
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   4
         Left            =   1470
         MouseIcon       =   "frmDosimArea.frx":0F1E
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":1070
         ToolTipText     =   "Buscar socio"
         Top             =   600
         Width           =   240
      End
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   5
         Tag             =   "DNI|T|N|||dosimarea|dni_usuario|||"
         Text            =   "Text1"
         Top             =   240
         Width           =   1335
      End
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   5
         Left            =   1470
         MouseIcon       =   "frmDosimArea.frx":1172
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":12C4
         ToolTipText     =   "Buscar socio"
         Top             =   240
         Width           =   240
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   39
         Tag             =   "Mes Par/Impar|T|N|||dosimarea|mes_p_i|||"
         Text            =   "Text1"
         Top             =   570
         Width           =   1425
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   10
         Tag             =   "Fecha Retirada|F|S|||dosimarea|f_retirada|dd/mm/yyyy||"
         Text            =   "Text1"
         Top             =   930
         Width           =   1395
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   9
         Tag             =   "Fecha Asignacion|F|N|||dosimarea|f_asig_dosimetro|dd/mm/yyyy||"
         Text            =   "Text1"
         Top             =   990
         Width           =   1335
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   32
         Tag             =   "Plantilla/Contrata|T|N|||dosimarea|plantilla_contrata|||"
         Text            =   "Text1"
         Top             =   570
         Width           =   1245
      End
      ...
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   40
         TabIndex        =   11
         Tag             =   "Observaciones|T|S|||dosimarea|observaciones|||"
         Text            =   "Text1"
         Top             =   1350
         Width           =   5280
      End
      Begin VB.TextBox Text1 
         ...
         MaxLength       =   10
         TabIndex        =   6
         Tag             =   "Tipo de Trabajo|T|N|||dosimarea|c_tipo_trabajo|||"
         Text            =   "Text1"
         Top             =   210
         Width           =   1320
      End
      Begin VB.Image ImgPpal 
         ...
         Index           =   0
         Left            =   1560
         MouseIcon       =   "frmDosimArea.frx":13C6
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":1518
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   1
         Left            =   5430
         MouseIcon       =   "frmDosimArea.frx":15A3
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":16F5
         ToolTipText     =   "Seleccionar fecha"
         Top             =   930
         Width           =   240
      End
      ...
      Begin VB.Image ImgPpal 
         ...
         Index           =   3
         Left            =   1500
         MouseIcon       =   "frmDosimArea.frx":1780
         MousePointer    =   99  'Custom
         Picture         =   "frmDosimArea.frx":18D2
         ToolTipText     =   "Buscar socio"
         Top             =   240
         Width           =   240
      End
   ...
   End
End
Attribute VB_Name = "frmDosimArea"
...
Private Sub BotonEliminar()
    ...
    Cad = "Seguro que desea eliminar el dosimetro de área:" & Data1.Recordset.Fields(0)
    '**********************************************************
                ...
                Case 4 ' tipos de trabajo
                    If Text1(Index).Text <> "" Then
                        ...
                        If Text2(0).Text = "" Then
                            MsgBox "El código de tipo de trabajo no existe. Reintroduzca.", vbExclamation
                            Text1(Index).Text = ""
                            PonerFoco Text1(Index)
                        End If
                    End If
...
Dim Titulo As String
        ...
        If Cad <> "" Then
            ...
            frmB.vTitulo = "Dosímetros de Area"
            frmB.vSelElem = 0
...
Dim Cad As String
    ...
    If (b = True) And ((Modo = 3) Or (Modo = 4)) Then
        ...
        If Datos = "" Then
            If MsgBox("No existe la Instalación para la Empresa. Desea continuar.", vbQuestion + vbYesNo + vbDefaultButton2) = vbNo Then
                DatosOk = False
                Exit Function
            End If
        End If
        ...
        If Datos = "" Then
            If MsgBox("No existe el operario en la instalación introducida. Desea continuar.", vbQuestion + vbYesNo + vbDefaultButton1) = vbNo Then
                DatosOk = False
                Exit Function
            End If
        End If
        If Text1(6).Text <> "" And Text1(10).Text <> "" Then
            If CDate(Text1(6).Text) > CDate(Text1(10).Text) Then
                MsgBox "La Fecha de Retirada no puede ser inferior a la de Asignación", vbExclamation
                DatosOk = False
                Exit Function
            End If
        End If
        ...
        If Text1(8).Text <> "" Then
            If DosimetroEnUso(Text1(8).Text, CLng(Text1(7).Text)) Then
                MsgBox "Este dosimetro está asignado a otra persona. Revise.", vbExclamation
                DatosOk = False
                Exit Function
            End If
        End If
...
If (b = True) And (Modo = 3) Then
    ...
    'la N es pa dir que es numeric
     Datos = DevuelveDesdeBD(1, "n_reg_dosimetro", "dosimarea", "n_reg_dosimetro|", Text1(7).Text & "|", "N|", 1)
     If Datos <> "" Then
...
Dim Sql As String
        ...
        Conn.Execute "Delete  from dosimarea " & Sql
