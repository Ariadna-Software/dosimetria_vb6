...
Begin VB.Form frmFactCaliPana 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Factores de Calibración Panasonic"
   ClientHeight    =   6255
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5640
   Icon            =   "frmFactCaliPana.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   3435
      TabIndex        =   2
      Tag             =   "Fecha Finalización|F|S|||factcalipana|f_fin|dd/mm/yyyy||"
      Text            =   "Dato4"
      Top             =   5490
      Width           =   1600
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   1800
      TabIndex        =   7
      Tag             =   "Fecha de Inicio|F|N|||factcalipana|f_inicio|dd/mm/yyyy|S|"
      Text            =   "Dato3"
      Top             =   5490
      Width           =   1600
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   975
      TabIndex        =   1
      Tag             =   "Cristal 2|N|N|0|999.999|factcalipana|cristal_b|||"
      Text            =   "Dato2"
      Top             =   5490
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      Left            =   150
      TabIndex        =   0
      Tag             =   "Cristal 1|N|N|0|999.999|factcalipana|cristal_a|||"
      Text            =   "Dato1"
      Top             =   5490
      Width           =   800
   End
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   5100
      TabIndex        =   4
      Tag             =   "Tipo|T|N|||factcalipana|tipo||S|"
      Text            =   "Tipo"
      Top             =   5490
      Visible         =   0   'False
      Width           =   390
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFactCaliPana.frx":030A
      Height          =   4365
      Left            =   135
      TabIndex        =   8
      Top             =   945
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Solapa"
      TabPicture(0)   =   "frmFactCaliPana.frx":031F
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).ControlCount=   0
      TabCaption(1)   =   "Anillo"
      TabPicture(1)   =   "frmFactCaliPana.frx":033B
      Tab(1).ControlEnabled=   0   'False
      Tab(1).ControlCount=   0
      TabCaption(2)   =   "Pulsera"
      TabPicture(2)   =   "frmFactCaliPana.frx":0357
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":0373
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":0485
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":0597
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":06A9
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":07BB
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":08CD
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":11A7
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":1A81
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":235B
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":2C35
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":350F
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":3961
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":3A73
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":3B85
            Key             =   ""
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":3C97
            Key             =   ""
         EndProperty
         BeginProperty ListImage16 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFactCaliPana.frx":4311
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "frmFactCaliPana"
...
Dim I As Integer
    ...
    CadenaConsulta = "Select * from factcalipana where 1=1 "
    CargaGrid ("factcalipana.f_inicio = '9999-99-99' and tipo ='" & txtAux(4).Text & "'")
...
Dim sql As String
    ...
    If MsgBox(sql, vbQuestion + vbYesNoCancel, "¡Atención!") = vbYes Then
        'Hay que eliminar
        sql = "Delete from factcalipana where f_inicio='" & Format(adodc1.Recordset!f_inicio, FormatoFecha) & "' and tipo ='" & txtAux(4).Text & "'"
        Conn.Execute sql
        CargaGrid "tipo ='" & txtAux(4).Text & "'"
    End If
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Case 11
            ...
            Screen.MousePointer = vbHourglass
            FrmListado.Opcion = 31 'Listado factores de calibracion panasonic
            FrmListado.Show
    Case 12
            Unload Me
    Case Else
...
Dim fecaux As Date
  ...
  If Not error And Modo = 1 Then
    ...
    sql = "select * from factcalipana where tipo = '" & txtAux(4).Text & "'"
